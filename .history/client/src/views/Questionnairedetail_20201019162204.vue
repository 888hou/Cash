<template>
    <div class="container">
        ...
        <div class="questions" v-for="(value, index) in questionData" :key="index">
            <p>{{value.order}}、{{value.name}}<span>({{value.remark}})</span></p>
            <el-input class="answer" v-if="value.type == '填空题'"></el-input>
            <el-input class="answer" type="textarea" v-if="value.type == '问答题'"></el-input>
