<template>
    <div class="container">
        ...
        <div class="questions" v-for="(value, index) in questionData" :key="index">
            ...
            <el-input class="answer" v-if="value.type == '填空题'" :placeholder="value.remark" ></el-input>
            <el-input class="answer" type="textarea" v-if="value.type == '问答题'" :placeholder="value.remark"></el-input>
