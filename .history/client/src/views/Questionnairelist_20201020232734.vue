...
<div class="fillContainer">
    ...
    <div class="table_container">
        ...
        style="width: 100%">
            ...
            <el-table-column
                v-for="(answer, index) in row.questions"
                :key="index"
                :prop="'questions'+index"
                label="答案"
                align='center'
                width="140">
                <template v-if="scope.row.questions[index]" slot-scope="scope">  
                    <span style="color:#4db3ff">{{ scope.row.questions[index].name +":"+ scope.row.questions[index].input }}</span>
                </template>
            </el-table-column>
            <!-- <el-table-column
                prop="begindate"
