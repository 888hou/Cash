    ...
    <div class="table_container">
        ...
        style="width: 100%">
            ...
            <template slot-scope="props">
                <el-form label-position="left" inline class="answeritem">
                <el-form-item v-for="(answer, index) in props.row.questions" :key="index" label="~">
                    <p class="answer">{{ answer.order }}、{{ answer.name }}</p>
                    <p class="answer">{{ answer.input }}</p>
                </el-form-item>
                </el-form>
            </template>
            </el-table-column>
