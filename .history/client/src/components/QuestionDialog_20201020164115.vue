            ...
            <div class="form">
                ...
                style="margin:10px;width:auto;">
                    ...
                    <el-form-item prop='type'  label="类型:">
                        ...
                        <el-button type="primary" v-if="formData.type == '单选题' || formData.type == '多选题'" @click='onAddAnswer()'>增加选项</el-button>
                    </el-form-item>
                    <el-form-item prop='require'  label="必填:">
                        <el-select v-model="formData.require" placeholder="是否必填">
                            <el-option
                             v-for="(type, index) in format_require_list"
                             :key="index"
                             :label="type" :value="type"
                            ></el-option>
                        </el-select>
                    </el-form-item>
                    <el-form-item v-for="(value, index) in formData.answer" prop='answer' :key="index" :label="'选项:'">
...
export default {
    ...
    methods: {
        ...
        onAddAnswer(){
            this.formData.answer.push('选项');
            console.log(this.format_answer_list);
        }
    },
    created(){
