            ...
            <div class="form">
                ...
                style="margin:10px;width:auto;">
                    ...
                    <el-form-item prop='mobile'  label="类型:">
                        ...
                        <el-button type="primary" v-if="formData.type == '选择题' || formData.type == '多选题'" @click='onAddAnswer(formData.type)'>增加选项</el-button>
                    </el-form-item>
                    <el-form-item v-for="(value, index) in formData.answer" prop='answer' :key="index" :label="'答案'+index+1+':'">
