  ...
  routes: [
    ...
    },
    {
      ...
      children:[
        ...
        {path:"/questionnairedetail/:id",name:'questionnairedetail',component:Questionnairedetail},
        {path:"/questionnairelist/:id",name:'questionnairelist',component:Questionnairelist},
