    ...
    <div class="suggestion">
      ...
      <van-form @submit="onSubmit">
        ...
        <div class="questions" v-for="(value, index) in questionData" :key="index">
            <p class="title">{{value.order}}、{{value.name}}<span v-if="value.remark">({{value.remark}})</span></p>
            ...
            <div class="answers" v-if="value.type == '单选题'">
                <van-radio-group v-model="answerData[value.id]">
                  <van-radio v-for="(value, index) in value.answer" :key="index" :name="value">{{value}}</van-radio>
                </van-radio-group>
            ...
            <div class="answers" v-if="value.type == '多选题'">
                <van-checkbox-group -group v-model="answerData[value.id]">
                  <van-checkbox v-for="(value, index) in value.answer" :key="index" :name="value">{{value}}</van-checkbox>
                </van-checkbox-group>
