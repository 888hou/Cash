        ...
        <div class="questions" v-for="(value, index) in questionData" :key="index">
            ...
            <div class="answers" v-if="value.type == '单选题'">
                <van-radio-group v-model="answerData[value._id]">
                  <van-radio v-for="(value, index) in value.answer" :key="index" :name="value" :rules="[{ required: true, message: '请填写'}]">{{value}}</van-radio>
                </van-radio-group>
            ...
            <div class="answers" v-if="value.type == '多选题'">
                <van-checkbox-group -group v-model="answerData[value._id]">
                  <van-checkbox v-for="(value, index) in value.answer" :key="index" :name="value" :rules="[{ required: true, message: '请填写'}]">{{value}}</van-checkbox>
                </van-checkbox-group>
