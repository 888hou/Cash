...
router.post("/answer/add",(req,res)=>{
    ...
    if(req.body.type) answerFields.type = req.body.type;
    if(req.body.status) answerFields.status = req.body.status;
    if(req.body.begindate) answerFields.begindate = req.body.begindate;
    if(req.body.enddate) answerFields.enddate = req.body.enddate;
    if(req.body.remark) answerFields.remark = req.body.remark;
    //返回信息
