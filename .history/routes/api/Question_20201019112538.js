...
router.post("/add",passport.authenticate("jwt",{session:false}),(req,res)=>{
    ...
    if(req.body.status) questionFields.status = req.body.status;
    if(req.body.begindate) questionFields.begindate = req.body.begindate;
    if(req.body.enddate) questionFields.enddate = req.body.enddate;
